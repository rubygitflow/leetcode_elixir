...
IO.inspect(Solution1955.count_special_subsequences([0,1,2]))
# Output: 1
IO.inspect(Solution1955.count_special_subsequences([0,1,2,0]))
# Output: 1
IO.inspect(Solution1955.count_special_subsequences([0,1,2,2]))
# Output: 3
IO.inspect(Solution1955.count_special_subsequences([2,2,0,0]))
# Output: 0
IO.inspect(Solution1955.count_special_subsequences([0,1,2,0,1,2]))
# Output: 7
